			...
			<div class="panel panel-default">
			  <div class="panel-body">
				<form id="roleForm" role="form" class="form-inline">
				  ...
				  <div class="form-group">
					  <button type="button" class="btn btn-success" style="float:right;" onclick="saveAssign()"><i class="glyphicon glyphicon-ok"></i> 保存</button>
				  </div>
				</form>
			  </div>
			</div>
        ...
        <script type="text/javascript">
            ...
            function saveAssign() {
                ...
                $.ajax({
					...
					data:{"role_ids":$role_ids.join(","),
							"user_id":$userid},
					success:function (result) {
						if(result.success){
							window.location.href = "${APP_PATH}/user/assign?id="+$userid;
						}else {
                            layer.msg("用户分配角色失败", {time:2000, icon:5, shift:6}, function(){
