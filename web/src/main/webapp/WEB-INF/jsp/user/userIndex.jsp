            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-inline" role="form" style="float:left;">
                        ...
                        <button id="" type="button" class="btn btn-warning"><i class="glyphicon glyphicon-search"></i> 查询</button>
                    </form>
            ...
            success : function(result) {
                ...
                if ( result.success ) {
                    ...
                    $.each(users, function(i, user){
                        ...
                        tableContent += '  <td>'+user.birthday+'</td>';
                        tableContent += '  <td>'+user.phone+'</td>';
                        tableContent += '  <td>'+user.wechat+'</td>';
                        tableContent += '  <td>';
