			  ...
			  <div class="panel-body">
				<form role="form">
				  ...
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="name" name="name" value="${vo.name}" placeholder="请输入菜单名称">
				  </div>
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#insertBtn").click(function(){
			    	var name = $("#name").val();
			    	if ( name == "" ) {
                        layer.msg("菜单名不能为空，请输入", {time:2000, icon:5, shift:6}, function(){
			    		...
			    		success : function(result) {
			    			...
			    			if ( result.success ) {
		                        layer.msg("用户信息保存成功", {time:1000, icon:6}, function(){
		                        	window.location.href = "${APP_PATH}/premission/index";
		                        });
			    			} else {
		                        layer.msg(result.mes, {time:2000, icon:5, shift:6}, function(){
