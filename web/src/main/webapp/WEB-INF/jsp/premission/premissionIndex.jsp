...
<script type="text/javascript">
    $(function () {
        ...
        var setting = {
            async: {
                enable: true,
                url:"${APP_PATH}/premission/loadData",
            ...
            view: {
                ...
                addDiyDom: function(treeId, treeNode){
                    ...
                    var icheck = $("#" + treeNode.tId + "_check");// tId = permissionTree_1, $("#permissionTree_1_ico")
                    icoObj.removeClass("button ico_docu ico_open").addClass(treeNode.icon).css("background","");
                    icheck.addClass("checkbox-success");
                },
    ...
    function addNode(id) {
        window.location.href = "${APP_PATH}/premission/input?pId="+id;
    }

    function editNode(id) {
        window.location.href = "${APP_PATH}/premission/input?id="+id;
    }
    ...
    function deleteNode(id) {
        layer.confirm("删除许可信息, 是否继续",  {icon: 3, title:'提示'}, function(cindex){
            ...
            $.ajax({
                type : "POST",
                url  : "${APP_PATH}/premission/delete",
                data : {
                    id : id
                },
